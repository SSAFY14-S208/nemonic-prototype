...
class NemonicDevice {
    ...
    _build() {
        ...
        const whiteMat = new THREE.MeshStandardMaterial({
            color: 0xfafafa, roughness: 0.4, metalness: 0.03
        });
        ...
        const lidMat = new THREE.MeshStandardMaterial({
            color: 0xf0f0f0, roughness: 0.35, metalness: 0.03
        });
        ...
        const slitMat = new THREE.MeshStandardMaterial({ color: 0xe0e0e0 });
    ...
    createPrintingMemo(texture) {
        ...
        this.printedMemo.position.set(0, topY - 0.4, -0.05);
        this.printedMemo.rotation.x = -0.25; // 살짝 뒤로 기울어짐
